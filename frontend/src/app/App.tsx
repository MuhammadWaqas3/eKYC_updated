...
export default function App() {
  ...
  const [cnicData, setCnicData] = useState<CNICData | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-[#e7e4e4]">
      ...
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-[#aa2771] to-[#8a1f5c] rounded-xl flex items-center justify-center shadow-md">
      ...
      {/* Progress Timeline - Only show if not on completion step */}
      {currentStep !== 6 && (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#aa2771]/10 rounded-lg flex items-center justify-center">
              ...
              <div className="flex items-center gap-6 text-xs text-[#626262]">
                <a
                  href="#"
                  className="hover:text-[#aa2771] transition-colors"
                >
                  Privacy Policy
                </a>
                <a
